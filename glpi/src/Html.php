...
HTML;
    ...
    {
        $message = "<a href=\"https://glpi.palaciodasferramentas.com.br/\" title=\"Powered by Teclib and implemented by Technology - Palácio das Ferramentas\" class=\"copyright\">";
        $message .= "GLPI ";
       // if required, add GLPI version (eg not for login page)
        if ($withVersion) {
            $message .= GLPI_VERSION . " ";
        }
        $message .= "Copyright (C) 2022-" . GLPI_YEAR . " Tecnologia - Palácio das Ferramentas" .
         "</a>";
        return $message;
    }
